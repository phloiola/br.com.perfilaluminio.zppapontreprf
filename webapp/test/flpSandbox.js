		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Relatório de Programação por Ferramenta",
									"targetURL": "#brcomperfilaluminiozppapontreprf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomperfilaluminiozppapontreprf-display": {
								"semanticObject": "brcomperfilaluminiozppapontreprf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.perfilaluminio.zppapontreprf",
									"url": sap.ui.require.toUrl("br/com/perfilaluminio/zppapontreprf")
								}
							}
						}
					}
